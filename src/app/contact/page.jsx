    ...
    return (
      ...
      >
        <div className="h-full flex flex-col lg:flex-row px-4 sm:px-8 md:px-12 lg:px-20 xl:px-48">
              ...
              {/* FORM CONTAINER */}
              <form onSubmit={sendEmail} ref={form} action="" className="h1/2 lg:h-full lg:w-1/2 bg-red-50 rounded-xl text-xl flex flex-col gap-8 justify-center p-24">
                    ...
                    {error && <span className="text-red-600 font-semibold"></span>}
              </form>
        </div>
      </motion.div>
    )
