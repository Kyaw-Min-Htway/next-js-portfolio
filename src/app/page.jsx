  ...
  return (
    <div className="h-full flex flex-col">
      ...
      <div className="h-1/2 flex flex-col gap-8 items-center justify-center">
        {/* TITLE */}
        <h1 className="text-4xl font-bold">Crafting Digital Experiences, Designing Tommorrow.</h1>
        {/* DESC */}
        <p className="">Welcome to my digital canvas, where innovation and creativity converge. With a keen eye for aesthetics and a mastery of code,
